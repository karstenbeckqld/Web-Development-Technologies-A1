...
public static class PerformInterAccountTransaction
{
    ...
    {
        //new EasyDB<Account>().Update(sourceAccount).ExecuteWithBool();
       // new EasyDB<Account>().Update(destinationAccount).ExecuteWithBool();
       // new EasyDB<Transaction>().Insert(sourceAccountTransaction).ExecuteWithBool();
       // new EasyDB<Transaction>().Insert(destinationAccountTransaction).ExecuteWithBool();
    }
