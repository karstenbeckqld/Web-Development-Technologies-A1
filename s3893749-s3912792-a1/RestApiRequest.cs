...
public class RestApiRequest
{
    ...
    {
        CustomerObjectList = RestCall();
    }
    
    /* To provide other classes access to the CustomerObjectList, we define a property that is accessible from outside the
     * class.
     */
    public List<Customer> CustomerObjectList { get; private set; }
    ...
    private static List<Customer> RestCall()
    {
